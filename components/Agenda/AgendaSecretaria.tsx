...
export default function AgendaSecretaria({ turnos, practitionerId }: Props) {
  ...
  useEffect(() => {
    if (practitionerId && token) {
      ...
      localStorage.setItem("MID", practitionerId);
    }
  }, [practitionerId, token, trigger]);
            ...
            <div className="flex flex-col items-center">
              ...
              {practitioner && (
                <div className="text-sm text-gray-600 mt-1">
                  Agenda de: {practitioner.gender === "male" ? "Dr." : "Dra."}{" "}
